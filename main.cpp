...
void print_startup_info() {
    ...
    cout << "This is a simple shell program to interact with the operating system." << endl;
...
#else
        cout << "Unknown command: " << command << ". Type 'help' for support." << endl;
#endif
    }
}
...
void sigint_handler(int signal) {
    ...
    // The active getline in main will fail, and we will clear cin's error state and re-print the prompt.
    cout << endl;
}
